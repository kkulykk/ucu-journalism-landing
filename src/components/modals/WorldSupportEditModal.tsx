...
const WorldSupportEditModal = (props: Props) => {
    ...
    try {
      ...
      if (!file) {
        ...
        const storageRef = ref(
          storage,
          `/worldSupport/${Date.now()}${fileName}`
        );
      ...
      const worldAboutUkraineEditRef = doc(firestore, CollectionNames.WORLD_SUPPORT, props.recordValuesObj.id);
...
export default WorldSupportEditModal;
